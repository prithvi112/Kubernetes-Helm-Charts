...
(-f parameter not required if using default values.yaml in the Chart directory)
- Update local repository - ```helm repo update < repository-name >```

## Helm Charts
| Type | Chart Name | Purpose | Directory | Values File Required |
|------|------------|---------|-----------|----------------------|
| Platform | Kubernetes Dashboard | Dashboard to monitor kubernetes clusters | kube-dashboard | YES |
